<template>
	<div class="article-container">
		<el-card class="filter-card">
			...
			<!-- 数据筛选表单 -->
			<el-form ref="form" :model="form" label-width="40px" size="mini" v-loading="loading">
				...
				<el-form-item label="日期">
					<el-date-picker format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="rangeDate" type="datetimerange"
			...
			<el-table :data="articles" stripe style="width: 100%" class="list-table" size="mini" v-loading="loading">
				<el-table-column prop="cover" label="封面">
					<template slot-scope="scope">
						<el-image :src="scope.row.cover.images[0]" fit="cover" style="width: 100px; height: 100px; cursor: pointer;"
						 :preview-src-list="scope.row.cover.images" lazy>
						</el-image>
						<!-- <img v-if="scope.row.cover.images[0]" class="article-cover" :src="scope.row.cover.images[0]" alt="" />
						<img v-else class="article-cover" src="./imgicon.png" alt="" /> -->
					</template>
				</el-table-column>
				...
				<el-table-column label="操作">
					...
					<template slot-scope="scope">
						<el-button size="mini" circle icon="el-icon-edit" type="primary" @click="$router.push('/publish?id='+scope.row.id)"></el-button>
